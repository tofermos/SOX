...
\item
  ...
  eficiència en la gestió de l'espai en disc. A banda de superar les
  limitacions com ja sabeu del curs passat de FAT32 i facilita d'accès
  per a Linux.
\end{itemize}
...
\begin{figure}
\centering
\includegraphics{https://tofermos.github.io/Windows11/interfaces/interfaces.html}
\caption{Introducció a l'entorn gràfic de Windows}
\end{figure}

\begin{figure}
\centering
\includegraphics{https://tofermos.github.io/Windows11/gestiodelequip/gestiodelequip.html}
\caption{Gestió des de l'entorn gràfic Windows}
\end{figure}
